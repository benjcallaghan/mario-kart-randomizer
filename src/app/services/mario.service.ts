...
export class MarioService {
  private static characters: MkItem[] = [
  ...
  private static gliders: MkItem[] = [
    { itemType: '', name: 'Super Glider', image: 'SuperGliderMK8.png' },
    { itemType: '', name: 'Cloud Glider', image: 'Cloud_Glider.png'},
    { itemType: '', name: 'Wario Wing', image: 'WarioWingMK8.png'},
    { itemType: '', name: 'Waddle Wing', image: 'WaddleWingMK8.png'},
    { itemType: '', name: 'Peach Parasol', image: 'PeachParasolGliderMK8.png'},
    { itemType: '', name: 'Parachute', image: 'ParachuteGliderMK8.png'},
    { itemType: '', name: 'Parafoil', image: 'ParafoilGliderMK8.png'},
    { itemType: '', name: 'Flower Glider', image: 'FlowerGliderMK8.png'},
    { itemType: '', name: 'Bowser Kite', image: 'BowserKiteMK8.png'},
    { itemType: '', name: 'Plane Glider', image: 'PlaneGliderMK8.png'},
    { itemType: '', name: 'MKTV Parafoil', image: 'MKTVParafoilGliderMK8.png'},
    { itemType: '', name: 'Gold Glider', image: 'GoldGliderMK8.png'},
    { itemType: '', name: 'Hylian Kite', image: 'MK8-HylianKite.png'},
    { itemType: '', name: 'Paper Glider', image: 'PaperGliderIconMK8.png'}
  ];
